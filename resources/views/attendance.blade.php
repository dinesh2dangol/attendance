...
<head>
    ...
    <style>
        ...
        .attendance-details { display: flex; flex-direction: column; gap: 0.35rem; margin-top: 0.65rem; }
        .attendance-details div { font-size: 0.82rem; color: #334155; }
        .attendance-details span { display: inline-block; min-width: 5.2rem; font-weight: 600; }
